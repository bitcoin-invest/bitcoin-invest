 ...
 */
static const char* BITCOIN_PID_FILENAME = "bitcoin-investd.pid";
...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-emergencystaking", "Accept emergencystaking", ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoininvest/bitcoininvest>";

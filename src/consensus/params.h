...
struct Params {
     ...
     * both chains, bitcoin and Bitcoin Invest are coming in sync with steps of this size. */
    int BTCIRewardMatchStep;
    /** Block height at which BTCIRewardMatch becomes active - rewards from
     * both chains, bitcoin and Bitcoin Invest are in sync as of this height. */
    int BTCIRewardMatchHeight;
    /** Block height at which BTCIDiffAdj becomes active - difficulty adjustment
     * formula is changed so that block times are more reliable. */
    int BTCIDiffAdjHeight;
    /**

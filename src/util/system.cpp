...
const char * const BITCOIN_CONF_FILENAME = "bitcoin-invest.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Bitcoin-invest
    // macOS: ~/Library/Application Support/Bitcoin-invest
    // Unix-like: ~/.bitcoin-invest
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitcoin-invest";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Bitcoin-invest";
#else
    // Unix-like
    return pathRet / ".bitcoin-invest";
#endif
#endif
}

...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //BTCITODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeBTCIs(bool fStake, CConnman* connman, ChainstateManager* chainman, CTxMemPool* mempool)
{
    ::StakeBTCIs(fStake, this, connman, chainman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman* connman, ChainstateManager* chainman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeBTCIs(true, connman, chainman, mempool);
}

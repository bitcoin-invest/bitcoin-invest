...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTCI: return QString("BTCI");
    case mBTCI: return QString("mBTCI");
    case uBTCI: return QString::fromUtf8("µBTCI (bits)");
...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uBTCI: return QString::fromUtf8("bits");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTCI: return QString("Bitcoins");
    case mBTCI: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTCI: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case BTCI: return 100000000;
    case mBTCI: return 100000;
    case uBTCI: return 100;
    case SAT: return 1;

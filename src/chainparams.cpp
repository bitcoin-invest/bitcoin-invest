...
{
    const char* pszTimestamp = "We are glad to be in the center of the world digital transformation";
...
public:
    CMainParams() {
        ...
        consensus.BTCIRewardMatchStep = 40000;
        consensus.BTCIRewardMatchHeight = 3 * consensus.BTCIRewardMatchStep;
        consensus.BTCIDiffAdjHeight = 130000;
        ...
        consensus.defaultAssumeValid = uint256S("0x000005a349a0f9da960918fac25d6c3ef0faa5b0d23a53158dc187ff72c2acfc"); //block 0
        ...
        genesis = CreateGenesisBlock(1607523000, 1834257, 0x1e0fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000005a349a0f9da960918fac25d6c3ef0faa5b0d23a53158dc187ff72c2acfc"));
        assert(genesis.hashMerkleRoot == uint256S("0x4014b57c0893499083344cff7a7a65ebc801780cc6c77489e3dead3b358b6b65"));
        ...
        vSeeds.emplace_back("159.89.5.52");
        vSeeds.emplace_back("142.93.174.247");
        vSeeds.emplace_back("104.248.28.189");
        ...
        checkpointData = {
            {
                { 0, uint256S("0x000005a349a0f9da960918fac25d6c3ef0faa5b0d23a53158dc187ff72c2acfc")},
...
public:
    CTestNetParams() {
        ...
        consensus.SegwitHeight = 1;
        consensus.MinBIP9WarningHeight = consensus.SegwitHeight + consensus.nMinerConfirmationWindow;
        consensus.BTCIRewardMatchStep = 400;
        consensus.BTCIRewardMatchHeight = 3 * consensus.BTCIRewardMatchStep;
        consensus.BTCIDiffAdjHeight = 1500;
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        consensus.defaultAssumeValid = uint256S("0x000005a349a0f9da960918fac25d6c3ef0faa5b0d23a53158dc187ff72c2acfc"); // 0
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("ntv3mtqw5wt63red.onion:28333");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1607523000, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x753b35c409c3ffa23826b65b8c1a99d7252312ec5786f4199f2cfd3fdc5d91a7"));
        assert(genesis.hashMerkleRoot == uint256S("0x4014b57c0893499083344cff7a7a65ebc801780cc6c77489e3dead3b358b6b65"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x753b35c409c3ffa23826b65b8c1a99d7252312ec5786f4199f2cfd3fdc5d91a7")},
            }
        };

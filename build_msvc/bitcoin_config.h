...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Invest Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Invest Core"
...
#define PACKAGE_NAME "Bitcoin Invest Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Invest Core 0.19.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoin-invest"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitcoin-invest.io/"
